		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="/admin-customer" modelAttribute="customer" method="post">
	...
	<div class="modal fade" id="editCustomer" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="/admin-edit-customer" modelAttribute="customer" method="post">
						<div class="form-group">
						...
						<div class="form-group">
							...
							<form:input path="email" type="text" class="form-control" id="edit-customer-email" placeholder="Email" />
						</div>
						<div class="form-group">
	...
	<div class="modal fade" id="deleteCustomer" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="/admin-delete-customer" modelAttribute="customer"
						method="POST">
						<div class="form-group">
	...
	<div class="modal fade" id="addType" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="/admin-type" modelAttribute="type" method="post">
	...
	<div class="modal fade" id="editType" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="/admin-edit-type" modelAttribute="type" method="post">
						<div class="form-group">
	...
	<div class="modal fade" id="deleteType" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="/admin-delete-type" modelAttribute="type"
						method="POST">
						<div class="form-group">
