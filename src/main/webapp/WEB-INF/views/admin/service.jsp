		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="/admin-service" modelAttribute="service" method="post">
	...
	<div class="modal fade" id="editService" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="/admin-edit-service" modelAttribute="service" method="post">
	...
	<div class="modal fade" id="deleteService" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="/admin-delete-service" modelAttribute="service"
						method="POST">
						<div class="form-group">
